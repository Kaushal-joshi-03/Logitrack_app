...
const seedDataDirectly = async () => {
  try {
    console.log('Clearing existing collections for in-memory seed...');
    ...
    console.error(`In-memory seeding failed: ${err.message}`);
  }
};

module.exports = { seedDataDirectly };